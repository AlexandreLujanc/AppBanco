...
@RestController
//https://localhost: 8080/transferencia
...
// indica que recibirá una petición GET en "/transferencia"
@GetMapping()
...
public Optional<Transferencia> obtenerTransferenciaPorFecha(@PathVariable("fecha") Date fecha)
{
return this.transferenciaService.buscarTransferenciaPorFecha(fecha) ;
}
...
@GetMapping(path = "/enviadas/{idOrdenante}")
public ArrayList<Transferencia> transferenciaEnviados(@PathVariable("idOrdenante") Integer id)
{
return this.transferenciaService.buscarTransferenciaEnviada(id);
}

@GetMapping(path = "/recibidas/{idBeneficiario}")
public ArrayList<Transferencia> transferenciaRecibidas(@PathVariable("idBeneficiario") Integer id)
{
return this.transferenciaService.buscarTransferenciaRecibidas(id);
}
}
